...
QT_MOC_LITERAL(4, 45, 27), // "on_connectionToPeer_clicked"
QT_MOC_LITERAL(5, 73, 30), // "on_writeNickOfPeer_textChanged"
QT_MOC_LITERAL(6, 104, 31), // "on_writeLanIpOfPeer_textChanged"
QT_MOC_LITERAL(7, 136, 31), // "on_writeWanIpOfPeer_textChanged"
QT_MOC_LITERAL(8, 168, 29), // "on_lineForTypeText_textEdited"
QT_MOC_LITERAL(9, 198, 8), // "QString&"
QT_MOC_LITERAL(10, 207, 8) // "messages"

    },
    "Freechat\0on_showNetworkInfo_clicked\0"
    "\0checked\0on_connectionToPeer_clicked\0"
    "on_writeNickOfPeer_textChanged\0"
    "on_writeLanIpOfPeer_textChanged\0"
    "on_writeWanIpOfPeer_textChanged\0"
    "on_lineForTypeText_textEdited\0QString&\0"
    "messages"
};
...
void Freechat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Freechat *_t = static_cast<Freechat *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_showNetworkInfo_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->on_connectionToPeer_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->on_writeNickOfPeer_textChanged(); break;
        case 3: _t->on_writeLanIpOfPeer_textChanged(); break;
        case 4: _t->on_writeWanIpOfPeer_textChanged(); break;
        case 5: _t->on_lineForTypeText_textEdited((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
